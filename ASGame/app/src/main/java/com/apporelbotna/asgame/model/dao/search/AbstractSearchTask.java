...
public abstract class AbstractSearchTask<Input, Progress, Return extends ConvertableTO> extends AsyncTask<Input, Progress, Return>
{
    ...
    public AbstractSearchTask(WeakReference ref)
    {
        super();
        this.ref = ref;
    }
