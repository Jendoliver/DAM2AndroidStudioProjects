...
public class PlayersFromGameSearchTask extends AbstractSearchTask<Integer, Void, StucomGamesDAOImpl.GameRankingTO>
{
    public PlayersFromGameSearchTask(WeakReference ref)
    {
        super(ref);
    }
